...
{
	std::cout << "New instance of " << *this << std::endl;
}
...
ClapTrap::~ClapTrap()
{
	std::cout << "ClapTrap is being destroyed "<< this->_name<< std::endl;
}
...
{
	std::cout << "ClapTrap is being assigned from other with " << rhs << std::endl;
...
{
	o << "ClapTrap:" << i.getName() << ":" << i.getEnergyPoints()<<":" << i.getHitPoints() << ":" << i.getAttackDamages();
	return o;
}
...
bool ClapTrap::_doAction()
{
	...
	{
		std::cout << "ClapTrap " << this->_name <<" is out of energy points and can't perform any action" <<std::endl;
		return false;
	}
	if(this->_hit_points <= 0)
	{
		std::cout << "ClapTrap " << this->_name <<" is out of hit points and can't perform any action" <<std::endl;
		return false;
	}
	this->_energy_points--;
	return true;
...
void ClapTrap::takeDamage(unsigned int amount)
{
	...
	std::cout << "ClapTrap " << this->_name <<" is taking " << amount << " points of damages!" <<std::endl;
}
...
void ClapTrap::beRepaired(unsigned int amount)
{
	if(!this->_doAction())
		return;
	this->_hit_points += amount;
	std::cout << "ClapTrap " << this->_name <<" is being repaired with " << amount << " energie points" <<std::endl;
